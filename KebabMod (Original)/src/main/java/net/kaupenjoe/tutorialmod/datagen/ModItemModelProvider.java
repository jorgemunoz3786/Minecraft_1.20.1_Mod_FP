...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.DILDO);

        trimmedArmorItem(ModItems.SUPER_HELMET);
        trimmedArmorItem(ModItems.SUPER_CHESTPLATE);
        trimmedArmorItem(ModItems.SUPER_LEGGINGS);
        trimmedArmorItem(ModItems.SUPER_BOOTS);
    }
